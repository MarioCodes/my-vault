...
-- Aloj. 1, Habitacion 1
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO, RESERVA_ID_RESERVA)
  VALUES(seq_hab_pk.nextval, 'MiniBar y Cafetera Italiana', 80, 0, 'simple', 'Bien Iluminada', 1, 1);
-- Aloj. 1, Habitacion 2
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO)
  VALUES(seq_hab_pk.nextval, 'Horno y Cabina de Hidromasaje', 180, 1, 'triple', 'Habitacion Amplia', 1);
  
-- Aloj. 2, Habitacion 1
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO)
  VALUES(seq_hab_pk.nextval, 'Microondas', 100, 0, 'simple', 'Habitacion Pequeña', 2);
-- Aloj. 2, Habitacion 2
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO, RESERVA_ID_RESERVA)
  VALUES(seq_hab_pk.nextval, 'Horno y Piscina', 200, 1, 'triple', 'Habitacion considerada de lujo', 2, 2);
  
-- Aloj. 3, Habitacion 1
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO)
  VALUES(seq_hab_pk.nextval, 'Cuarto de baño', 90, 1, 'simple', 'Habitacion de transito', 3);
-- Aloj. 3, Habitacion 2
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO, RESERVA_ID_RESERVA)
  VALUES(seq_hab_pk.nextval, 'Horno, Piscina y Aire acondicionado', 300, 1, 'cuadruple', 'Habitacion para familias', 3, 3);
  
-- Aloj. 4, Habitacion 1
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO)
  VALUES(seq_hab_pk.nextval, 'Trastero', 110, 0, 'simple', 'Habitacion para dormir', 4);
-- Aloj. 4, Habitacion 2
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO, RESERVA_ID_RESERVA)
  VALUES(seq_hab_pk.nextval, 'Jardin', 210, 1, 'doble', 'Habitacion comoda', 4, 4);
  
-- Aloj. 5, Habitacion 1
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO)
  VALUES(seq_hab_pk.nextval, 'Horno', 120, 0, 'simple', 'Habitacion luminosa', 5);
-- Aloj. 5, Habitacion 2
INSERT INTO HABITACION(ID_HABITACION, EXTRAS_HABITACION, PRECIO, CUARTO_BAÑO, TIPO_HABITACION, RESEÑAS, ALOJAMIENTO_ID_ALOJAMIENTO, RESERVA_ID_RESERVA)
  VALUES(seq_hab_pk.nextval, 'Jardin y piscina', 180, 1, 'doble', 'Habitacion tranquila', 5, 5);
