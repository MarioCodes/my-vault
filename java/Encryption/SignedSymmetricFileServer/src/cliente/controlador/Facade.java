...
public class Facade {
    ...
    public static String getSimetrica(Rsa rsa) {
        return red.getSimetrica(rsa);
    }
     ...
     */
    public static void envioFicheroClienteServer(String clave, Rsa rsa, String ip, int puerto, String rutaServer, String rutaLocal, String nombreFich) {
        red.envioFicheroClienteServer(clave, rsa, rutaServer, rutaLocal, nombreFich);
    }
     ...
     * @param nombreFich Nombre del fichero a copiar.
     */
    public static void envioFicheroServerCliente(String clave, Rsa rsa, String ip, int puerto, String rutaServer, String rutaLocal, String nombreFich) {
        red.reciboFicheroServerCliente(clave, rsa, rutaServer, rutaLocal, nombreFich);
    }
