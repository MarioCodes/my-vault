...
import cliente.controlador.Facade;
import cliente.controlador.Mapeador;
import cliente.controlador.Red;
import comun.Rsa;
import java.io.File;
...
public class MainWindow extends javax.swing.JFrame {
    private final Rsa RSA = new Rsa(256);
    private final int BUFFER_LENGTH = 128;
    private String claveSimetrica = null;
    ...
    public MainWindow() {
        ...
        Red.setBufferLength(BUFFER_LENGTH);
    }
    ...
    /**
     * Comprobacion de que el servidor esta alcanzable y intercambio de claves publicas.
     *  Cambia el Icon de la barra principal en funcion de la conexion.
     */
    private void intercambioClaves() {
        ...
        Runnable runnable = () ->  {
            ...
            RSA.setCLAVE_AJENA_PUBLICA(Facade.intercambioClaves(RSA, RSA.getCLAVE_PROPIA_PUBLICA()));
            claveSimetrica = Facade.getSimetrica(RSA);
            System.out.println("Clave simetrica recibida.");
        };
    ...
    private void recoleccionDatosEnvioFichero() {
        ...
        Facade.envioFicheroClienteServer(claveSimetrica, RSA, url, puerto, rutaServerSeleccionada, rutaLocalRecortada, nombreFichero);
    }
    ...
    private void recoleccionDatosRecibimientoFichero() {
        ...
        Facade.envioFicheroServerCliente(claveSimetrica, RSA, url, puerto, rutaServerRecortada, rutaLocal, nombreFichero);
    }
    ...
    private void initComponents() {
        ...
        jLabelEstadoConexion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/Cross.png"))); // NOI18N
        ...
        jButtonRefrescarCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/refresh.png"))); // NOI18N
        ...
        jButtonCrearCarpeta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/folder.png"))); // NOI18N
        ...
        jButtonBorrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/delete.png"))); // NOI18N
        ...
        jButtonRefrescarServer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/refresh.png"))); // NOI18N
        ...
        jButtonCrearCarpetaServer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/folder.png"))); // NOI18N
        ...
        jButtonBorrarServer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/delete.png"))); // NOI18N
        ...
        jButtonPasarACliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/flecha_forward.png"))); // NOI18N
        ...
        jButtonPasarAServer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cliente/imagenes/flecha_backward.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Cliente Simetrico Firmado.");
        setArbolCliente();
    }
    ...
    private static class conversionJTreePath {
        ...
        private static String conversion(boolean isServer, String pathEstiloJTree) {
            String convertida = "";
            if(isServer) convertida += "rootServer\\";
