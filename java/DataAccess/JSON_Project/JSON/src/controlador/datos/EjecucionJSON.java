...
public class EjecucionJSON {
    private static final String SHARED_BASE_URL = "http://localhost/ServerWeb/"; //fixme: Acordarme que en casa cambie los puertos de acceso a :8088 por problemas de compatibilidad con VirtualBox.
