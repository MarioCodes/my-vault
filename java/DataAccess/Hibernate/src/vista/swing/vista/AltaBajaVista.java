...
import hibernate.dto.Actividad;
import hibernate.dto.Alojamiento;
 ...
 * @since 21/02/2017
 */
public class AltaBajaVista extends javax.swing.JFrame {
     ...
     */
    public AltaBajaVista(boolean alta) {
        initComponents();
...
//        s.delete(new VistaActividadesAlojamiento(vId));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if(alojamiento != null) new MostrarAlojamiento(alojamiento);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if(actividad != null) new MostrarActividad(actividad);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if(AltaBajaVista.jLabelAlojamiento.getText().isEmpty() | AltaBajaVista.jLabel5.getText().isEmpty()) JOptionPane.showMessageDialog(this, "Selecciona dos elementos validos.");
        else {
    ...
    public static void setAlojamiento(Alojamiento aAlojamiento) {
        ...
        AltaBajaVista.jLabelAlojamiento.setText(alojamiento.getNombre());
    }
    ...
    public static void setActividad(Actividad aActividad) {
        ...
        AltaBajaVista.jLabel5.setText(actividad.getNombre());
    }
